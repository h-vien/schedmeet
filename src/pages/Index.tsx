...
import { CalendarIcon, Clock, Users, Share2 } from "lucide-react";
...
const Index = () => {
  ...
  const handleCreateEvent = () => {
    ...
    // Store event data in localStorage (in a real app, this would be stored in a database)
    const eventData = {
      id: eventId,
      name: eventName,
      dates: selectedDates,
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6 rounded-lg bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-gray-600">Select multiple dates and time ranges with just a few clicks</p>
          </div>
          <div className="text-center p-6 rounded-lg bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300 hover:scale-105">
            <Users className="w-12 h-12 mx-auto mb-4 text-green-600" />
            <h3 className="text-lg font-semibold mb-2">Visual Availability</h3>
            <p className="text-gray-600">See everyone's availability at a glance with our heatmap grid</p>
          </div>
          <div className="text-center p-6 rounded-lg bg-white/50 backdrop-blur-sm border border-white/20 hover:bg-white/70 transition-all duration-300 hover:scale-105">
            <Share2 className="w-12 h-12 mx-auto mb-4 text-purple-600" />
            <h3 className="text-lg font-semibold mb-2">Easy Sharing</h3>
            <p className="text-gray-600">Share your poll with a simple link and optional password protection</p>
          </div>
        </div>
