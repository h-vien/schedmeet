            ...
            <div className='container mx-auto px-4'>
              <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                <div className='text-gray-600 max-w-md'>
                  <p className='mb-2'>
                    SchedMeet helps you find the perfect time for your meetings
                    and events by making group scheduling simple and visual.
                  </p>
                  <p>
                ...
                <div className='flex flex-col items-end gap-2'>
                  <a
                    href='https://github.com/yourusername/SchedMeet'
                    target='_blank'
