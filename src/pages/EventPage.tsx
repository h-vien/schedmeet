...
const EventPage = () => {
  ...
  const totalParticipants = eventData ? Object.keys(eventData.responses).length : 0;
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <Badge variant="outline">
                {eventData.dates.length} date{eventData.dates.length !== 1 ? 's' : ''}
              </Badge>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter your name and select your availability
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <div>
                  <strong>Time Range:</strong> {format(parse(eventData.timeRange.start, 'HH:mm', new Date()), 'h:mm a')} - {format(parse(eventData.timeRange.end, 'HH:mm', new Date()), 'h:mm a')}
                </div>
                <div>
                  <strong>Dates:</strong>
